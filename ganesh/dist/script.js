        ...
        Lion = function(){
            ...
            this.backLeftFoot.position.z = 30; this.backLeftFoot.position.x = 75; this.backLeftFoot.position.y = -90;
            
            this.backRightFoot = new THREE.Mesh(footGeom, this.yellowMat);
            this.backRightFoot.position.z = 30; this.backRightFoot.position.x = -75; this.backRightFoot.position.y = -90;
            
            this.frontRightFoot = new THREE.Mesh(footGeom, this.yellowMat);
            this.frontRightFoot.position.z = 40; this.frontRightFoot.position.x = -22; this.frontRightFoot.position.y = -90;
            
            this.frontLeftFoot = new THREE.Mesh(footGeom, this.yellowMat);
            this.frontLeftFoot.position.z = 40; this.frontLeftFoot.position.x = 22; this.frontLeftFoot.position.y = -90;
            ...
            for (var j=0; j<4; j++){
                for (var k=0; k<4; k++){
                    ...
                    if ((j==0 && k==0) || (j==0 && k==3) || (j==3 && k==0) || (j==3 && k==3)){
                        amp = -10-Math.floor(Math.random()*5); zOffset = -5;
                    }else if (j==0 || k ==0 || j==3 || k==3){
                        amp = -5-Math.floor(Math.random()*5); zOffset = 0;
                    }else{
                        amp = 0; zOffset = 0;
                    }
            ...
            this.mustache2 = this.mustache1.clone(); this.mustache2.position.set(35, -12, 175);
            this.mustache3 = this.mustache1.clone(); this.mustache3.position.set(30, -19, 175);
            this.mustache4 = this.mustache1.clone(); this.mustache4.rotation.z = Math.PI; this.mustache4.position.x = -30;
            this.mustache5 = this.mustache2.clone(); this.mustache5.rotation.z = Math.PI; this.mustache5.position.x = -35;
            this.mustache6 = this.mustache3.clone(); this.mustache6.rotation.z = Math.PI; this.mustache6.position.x = -30;
            
            this.mustaches.push(this.mustache1, this.mustache2, this.mustache3, this.mustache4, this.mustache5, this.mustache6);
            
            this.spot1 = new THREE.Mesh(spotGeom, this.redMat);
            this.spot1.position.set(39, 0, 150);
            this.spot2 = this.spot1.clone(); this.spot2.position.set(39, -10, 160);
            this.spot3 = this.spot1.clone(); this.spot3.position.set(39, -15, 140);
            this.spot4 = this.spot1.clone(); this.spot4.position.set(39, -20, 150);
            this.spot5 = this.spot1.clone(); this.spot5.position.x = -39;
            this.spot6 = this.spot2.clone(); this.spot6.position.x = -39;
            this.spot7 = this.spot3.clone(); this.spot7.position.x = -39;
            this.spot8 = this.spot4.clone(); this.spot8.position.x = -39;
            
            this.leftEye = new THREE.Mesh(eyeGeom, this.whiteMat); this.leftEye.position.set(40, 25, 120);
            this.rightEye = new THREE.Mesh(eyeGeom, this.whiteMat); this.rightEye.position.set(-40, 25, 120);
            this.leftIris = new THREE.Mesh(irisGeom, this.purpleMat); this.leftIris.position.set(42, 25, 120);
            this.rightIris = new THREE.Mesh(irisGeom, this.purpleMat); this.rightIris.position.set(-42, 25, 120);
            
            this.mouth = new THREE.Mesh(mouthGeom, this.blackMat); this.mouth.position.set(0, -30, 171); this.mouth.scale.set(.5,.5,1);
            this.smile = new THREE.Mesh(smileGeom, this.greyMat); this.smile.position.set(0, -15, 173); this.smile.rotation.z = -Math.PI;
            this.lips = new THREE.Mesh(lipsGeom, this.yellowMat); this.lips.position.set(0, -45, 165);
            this.rightEar = new THREE.Mesh(earGeom, this.yellowMat); this.rightEar.position.set(-50, 50, 105);
            this.leftEar = new THREE.Mesh(earGeom, this.yellowMat); this.leftEar.position.set(50, 50, 105);
            this.nose = new THREE.Mesh(noseGeom, this.greyMat); this.nose.position.set(0, 25, 170);
            
            this.head = new THREE.Group();
            this.head.add(this.face); this.head.add(this.mane); this.head.add(this.rightEar); this.head.add(this.leftEar);
            this.head.add(this.nose); this.head.add(this.leftEye); this.head.add(this.rightEye); this.head.add(this.leftIris);
            this.head.add(this.rightIris); this.head.add(this.mouth); this.head.add(this.smile); this.head.add(this.lips);
            this.head.add(this.spot1, this.spot2, this.spot3, this.spot4, this.spot5, this.spot6, this.spot7, this.spot8);
            this.head.add(this.mustache1, this.mustache2, this.mustache3, this.mustache4, this.mustache5, this.mustache6);
            
            this.head.position.y = 60;
            this.threegroup.add(this.body); this.threegroup.add(this.head); this.threegroup.add(this.leftKnee);
            this.threegroup.add(this.rightKnee); this.threegroup.add(this.backLeftFoot); this.threegroup.add(this.backRightFoot);
            this.threegroup.add(this.frontRightFoot); this.threegroup.add(this.frontLeftFoot);
        ...
        Lion.prototype.look = function(xTarget, yTarget){
            ...
            this.tHeadPosZ = 0;
            this.tEyeScale = 1; this.tIrisYScale = 1; this.tIrisZScale = 1;
            ...
            this.tLipsPosX = 0; this.tLipsPosY = -45;
            this.tSmilePosX = 0; this.tMouthPosZ = 174; this.tSmilePosZ = 173; this.tSmilePosY = -15; this.tSmileRotZ = -Math.PI;
            ...
            this.updateBody(10);
            this.mane.rotation.y = 0; this.mane.rotation.x = 0;
            for (var i=0; i<this.maneParts.length; i++){
                var m = this.maneParts[i].mesh;
                m.position.z = 0; m.rotation.y = 0;
            }
        ...
        Lion.prototype.cool = function(xTarget, yTarget, deltaTime){
            ...
            this.tHeadPosZ = 100;
            this.tEyeScale = 0.1; this.tIrisYScale = 0.1; this.tIrisZScale = 3;
            this.tIrisPosY = 20; this.tLeftIrisPosZ = 120; this.tRightIrisPosZ = 120;
